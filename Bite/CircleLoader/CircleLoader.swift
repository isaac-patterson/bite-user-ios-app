...
struct CircleLoader: View {
    ...
    let circleRoundGradient = LinearGradient(gradient: .init(colors: [Color.appThemeMustured, Color.appThemeMusturedLight]), startPoint: .topLeading, endPoint: .trailing)
